package com.avverma._2024.day5.part2;
...
public class PrintQueue {
   ...
   void swap(List<String> pageUpdate, int i, int j) {
       String temp = pageUpdate.get(i);
       pageUpdate.set(i, pageUpdate.get(j));
       pageUpdate.set(j, temp);
   }
